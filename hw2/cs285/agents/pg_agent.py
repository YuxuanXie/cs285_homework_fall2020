...
class PGAgent(BaseAgent):
    ...
    def train(self, observations, actions, rewards_list, next_observations, terminals):
        ...
        # TODO_: step 3: use all datapoints (s_t, a_t, q_t, adv_t) to update the PG actor/policy
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        if self.nn_baseline:
            ...
            ## TODO_: compute advantage estimates using q_values and baselines
        ...
        if self.standardize_advantages:
            ## TODO_: standardize the advantages to have a mean of zero
    ...
    def _discounted_return(self, rewards):
        ...
        # TODO_: create list_of_discounted_returns
